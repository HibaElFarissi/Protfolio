...
@section('title', ($isUpdate ? 'Update' : 'Create') . ' Protfolio')

@php
    $route = route('Protfolios.store');
    if ($isUpdate) {
        $route = route('Protfolios.update', $Protfolios);
    }
    @endphp
...
@include('layouts.errors-notif')
    ...
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18">Create Project</h3>
        <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
            ...
            <li>
                <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">Create Project</span>
            </li>
        </ul>
    </div>
    <div class="row">
        <div class="col">
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <h3 class="fs-18  border-bottom pb-20 mb-20">Create Project</h3>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="text" name="name" value="{{ old('name',$Protfolios->name) }}" class="form-control text-dark ps-5 h-58"
                                            placeholder="EnvyTheme">
                                        <i
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="date" name="Start_Date" value="{{ old('Start_Date',$Protfolios->Start_Date) }}" class="form-control text-gray-light h-58">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="date" name="End_Date" value="{{ old('End_Date',$Protfolios->End_Date) }}" class="form-control text-gray-light h-58">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <textarea id="summernote" name="description"  class="form-control ps-5 text-dark" placeholder=" Project Text ... "
                                            cols="30" rows="5">{{ old('description', $Protfolios->description) }}</textarea>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="text" name="Client" value="{{ old('Client',$Protfolios->Client) }}" class="form-control text-dark h-58 ps-5"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="text" name="Link_website" value="{{ old('Link_website',$Protfolios->Link_website) }}" class="form-control text-dark h-58 ps-5"
                                            placeholder="Enter rate">
                                        <i
                                            class="ri-briefcase-line position-absolute top-50 start-0 translate-middle-y fs-20 text-gray-light ps-20"></i>
                                    </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary py-3 px-5 fw-semibold text-white">Create Project</button>
                                </div>
                            </div>
                        </div>
                    </form>
