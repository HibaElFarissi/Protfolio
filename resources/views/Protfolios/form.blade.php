                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="date" name="Start_Date" class="form-control text-gray-light h-58">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="date" name="date_final" class="form-control text-gray-light h-58">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="text" name="Client" class="form-control text-dark h-58 ps-5"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="text" name="View_website" class="form-control text-dark h-58 ps-5"
                                            placeholder="Enter rate">
                                        <i
                                            class="ri-briefcase-line position-absolute top-50 start-0 translate-middle-y fs-20 text-gray-light ps-20"></i>
                                    </div>
