...
@section('content')
    ...
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        ...
        <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
            ...
            <li>
                <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">Experiences</span>
            </li>
        </ul>
    </div>
    <div class="card bg-white border-0 rounded-10 mb-4">
        <div class="card-body p-4">
            <div class="d-sm-flex justify-content-between align-items-center border-bottom pb-20 mb-20">
                <h4 class="fw-bold fs-18 mb-0 text-center">Experiences</h4>
    ...
    @empty
        <tr>
            <td colspan="9" align="center">
                <h5>There is no Experience here !! </h5>
            </td>
        </tr>
    @endforelse
