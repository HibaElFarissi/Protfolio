                                    ...
                                    <tr class="text-center">
                                        <td class="text-start">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <img src="{{ asset('storage/' . $Skill->image) }}" class="wh-44 rounded-circle"
                                                alt="{{$Skill->image}}">
                                            </div>
                                            </div>
                                        </td>
        ...
        <div class="offcanvas-body p-4">
            <form  action="{{ route('Skills.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="form-group mb-4">
                        <label class="label">You image</label>
                        <input type="file" name="image" class="form-control text-dark file @error('name') is-invalid @enderror">
                        @error('image')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
