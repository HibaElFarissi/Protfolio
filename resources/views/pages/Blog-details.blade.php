                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="postbox__main-wrapper">
                                            ...
                                            <div class="postbox__meta-item">
                                                <div class="postbox__meta-author">
                                                    <div class="postbox__meta-author-thumb">
                                                        <a href="#">
                                                            <img src="assets/imgs/user/user-03.png"
                                                                alt="image not found">
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="postbox__details-content-wrapper">
                                            <h5 class="postbox__details-title">Just set something gratifying to indulge
                                            ...
                                            <p class="mb-20">One morning, when Gregor Samsa woke from troubled dreams,
                                                ...
                                                <ul>
                                                        ...
                                                        <div class="postbox__comment-box">
                                                            <div class="postbox__comment-info">
                                                                <div class="postbox__comment-avater">
                                                                    <img src="assets/imgs/user/user-08.png" alt="image">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <li>
                                                        <div class="postbox__comment-box">
                                                            <div class="postbox__comment-info">
                                                                <div class="postbox__comment-avater">
                                                                    <img src="assets/imgs/user/user-10.png" alt="image">
                                                                </div>
                                                            </div>
                                                            <div class="postbox__comment-text ">
                                                                <div class="postbox__comment-name">
                                            ...
                                            <div class="sidebar__widget-content">
                                                <div class="sidebar__post">
                                                    <div class="rc__post">
                                                        ...
                                                        <div class="rc__post-content">
                                                            <h6 class="rc__post-title">
                                                                <a href="blog-details.html">Prepare for the Future of
                                                                    and idea</a>
                                                            </h6>
                                                            <div class="rc__meta">
                                                                <span>
                                                    ...
                                                    <div class="rc__post">
                                                        ...
                                                        <div class="rc__post-content">
                                                            <h6 class="rc__post-title">
                                                                <a href="blog-details.html">Developing privacy user
                                                                    centric apps</a>
                                                            </h6>
                                                            <div class="rc__meta">
                                                                <span>
                                                    ...
                                                    <div class="rc__post">
                                                        ...
                                                        <div class="rc__post-content">
                                                            <h6 class="rc__post-title">
                                                                <a href="blog-details.html">Starting and Growing
                                                                    Design</a>
                                                            </h6>
                                                            <div class="rc__meta">
                                                                <span>
