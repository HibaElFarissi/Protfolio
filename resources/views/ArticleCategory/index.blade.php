...
<br>
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18">Article Categories</h3>
        <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
            ...
            <li>
                <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">Article_Categories</span>
            </li>
        </ul>
    </div>
                    ...
                    <div class="default-table-area recent-files-list">
                        <div class="table-responsive">
                            <table class="table align-middle">
                                ...
                                <tbody>
                                    @forelse ( $articleCategory as $item )
                                    <tr class="text-center">
                                        <td class="text-start">
                                        ...
                                        <td>
                                            <div class="dropdown action-opt">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('ArticleCategory.edit', $item->id) }}">
                                                    ...
                                                    <li>
                                                        ...
                                                        <form action="{{ route('ArticleCategory.destroy', $item) }}" method="POST" class="dropdown-item" >
                                                            @csrf
                                                            @method('DELETE')
