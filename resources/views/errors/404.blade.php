            ...
            <div class="col-xl-6 col-lg-8 col-md-10">
                <div class="error__thumb-wrapper p-relative wow fadeInUp" data-wow-delay=".3s"
                    ...
                    <div class="error__thumb">
                        <img src="{{ asset('assets/imgs/error/error.png') }}" alt="image">
                    </div>
                    <div class="error__shape-wrapper">
                        <div class="error__shape-one">
                            <img src="{{ asset('assets/imgs/shape/error-shape-01.png') }}" alt="image">
                        </div>
                        <div class="error__shape-two">
                            <img src="{{ asset('assets/imgs/shape/error-shape-02.png') }}" alt="image">
                        </div>
                        <div class="error__shape-three">
                            <img src="{{ asset('assets/imgs/shape/error-shape-03.png') }}" alt="image">
                        </div>
                        <div class="error__shape-four">
                            <img src="{{ asset('assets/imgs/shape/error-shape-04.png') }}" alt="image">
                        </div>
                    </div>
                </div>
