...
@section('content')
    <form class="row g-3 needs-validation" action="{{ route('Tags.update', $Tag->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="col-md-6">
            <br><br>
        ...
        <div class="col-12">
            <button class="btn btn-primary fw-semibold text-white py-2 px-3" type="submit">Edit Tag</button>
        </div>
    </form>
    <br>
    <br>
