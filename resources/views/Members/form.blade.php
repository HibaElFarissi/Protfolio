...
@section('title' , ($isUpdate?'Update':'Create') . ' Member')
...
@include('layouts.errors-notif')
    ...
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18">Member Info</h3>
        <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
            ...
            <li>
                <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">Member Informations</span>
            </li>
        </ul>
    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            <x-text-input id="name" name="name" type="text"
                                                class="form-control text-dark ps-5 h-58" :value="old('name', $Member->name)" required autofocus
                                                autocomplete="name" />
                                            <i
                                 ...
                                 <div class="col-lg-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            ...
                                            class="form-control text-dark ps-5 h-58" :value="old('work', $Member->work)" required autofocus
                                            autocomplete="work" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            <input type="url" name="Linkedin" class="form-control text-dark ps-5 h-58" value="{{old('Linkedin', $Member->Linkedin)}}"  required autofocus placeholder="URL">
                                            <i
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            <input type="url" name="Github" class="form-control text-dark ps-5 h-58" value="{{old('Github', $Member->Github)}}" required autofocus placeholder="URL">
                                            <i
